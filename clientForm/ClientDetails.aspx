...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdnStatusidx" runat="server" />
        ...
        <div id="tabs">
            <ul class="nav nav-tabs">
                ...
                <li style="width: 76%; display: none" id="lblCFIDandClientName">
                    <label class="MainHeadingCFID">ClientCode:</label><label class="MainHeadingCFIDvalue" id="lblCFId"></label>
                    <label class="MainHeadingCLientName">Client Name:</label>
                    <label id="MainHeadingCLientName" class="MainHeadingCFIDvalue"></label>
                </li>
            </ul>
        </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-xs-4  col-sm-2">
                        ...
                        <ul id="ClientMenu" class="nav nav-tabs tabs-left sideways" style="margin-left: -30px;">
                            ...
                            <li id="contInfoTab"><a href="#ContactInfo" >Contact Info</a></li>
                            <li><a href="#OtherDetails" >Other Details</a></li>
                            <li id="BusClassAllRate"><a href="#BusinessDetail" >Business Details </a></li>
                            <li id="BusclasRate"><a href="#BusniessInfo" >Business Rates </a></li>
                            <li id="AgentRate"><a href="#AgentProducer" >Agent / Producer</a></li>
                            <li><a href="#Compliance" >AML / Compliance</a></li>
                            <li id="InstalTab"><a href="#InstallmentMode" >Credit Terms</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home-v">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Client Name <span class="requiredFieldlable">*</span></label>
                                        ...
                                        <div class="col-sm-4" id="form_test">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Cnic <span class="requiredFieldlable">*</span></label>
                                                    <%--<input type="text"  data-inputmask="'mask': '99999-9999999-9'"  placeholder="XXXXX-XXXXXXX-X"  name="cnic" required="" />--%>
                                                    <asp:TextBox ID="txtNic" runat="server" required="" minlength="15" CssClass="md-input " name="cnic"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Cnic Issue Date <span class="requiredFieldlable">*</span></label>
                                                    <asp:TextBox ID="txtIssueDate" required="" runat="server" CssClass="datepicker  md-input"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Cnic Expiry Date <span class="requiredFieldlable">*</span></label>
                                                    <asp:TextBox ID="txtExpireDate" required="" runat="server" CssClass="datepicker  md-input "></asp:TextBox>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first" id="NTNDiv">
                                                <div class="md-input-wrapper">
                                                    <label>Ntn</label>
                                                    <asp:TextBox ID="txtNTN" minlength="7" required="" runat="server" CssClass="md-input"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4" id="STNDiv">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Stn</label>
                                                    <asp:TextBox ID="txtSTN" minlength="13" runat="server" CssClass="md-input"></asp:TextBox>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                            <input type="checkbox" class="radioCheck" name="filerCheck" id="c01" value="YES" />Filer  
                                           &nbsp;&nbsp;&nbsp;
                                            <input type="checkbox" class="radioCheck" name="filerCheck" id="c02" value="NO" />Non Filer
                                      <br />
                                            <%--onclick="check(this);"--%>
                                            <div id="FilerDiv" style="display: none">
                                                <input style="margin-top: 10px" type="file" multiple="multiple" id="filerFileUpload" />
                                                <%--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp--%>
                                                <a href="https://e.fbr.gov.pk/esbn/Service.aspx?PID=LKhSnIhZDBeCYTOJOVM5LA%3d%3d" target="_blank">Online Ntn/Stn Verification</a>
                                                <br />
                                                <span style="color: red;">Please Attach FBR Screenshot</span>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <label style="margin-top: 8px;">Cnic Upload</label>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="uk-width-medium uk-row-first">
                                                <br />
                                                <div class="md-input-wrapper">
                                                    <label>Address <span class="requiredFieldlable">*</span></label>
                                                    <asp:TextBox ID="txtAdress" runat="server" required="" CssClass="md-input"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Email <span class="requiredFieldlable">*</span></label>
                                                    <asp:TextBox ID="txtEmail" runat="server" required="" CssClass="md-input textlower"></asp:TextBox>
                                        ...
                                        <div class="col-sm-4">
                                            <label>Mobile No <span class="requiredFieldlable">*</span></label>
                                            <div class="uk-width-medium uk-row-first">

                                                <div class="md-input-wrapper" style="display: flex;">


                                                    <asp:DropDownList ID="ddlMobileCode" required="" Width="67px" runat="server" CssClass="md-input">
                                                        <%--   <asp:ListItem disabled="" Selected="" hidden="">Code</asp:ListItem>--%>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    ...
                                                    <asp:TextBox ID="txtContactPerson" runat="server" CssClass="md-input"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    ...
                                                    <asp:TextBox ID="txtDesgRef" runat="server" CssClass="md-input"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                ...
                                                <div class="md-input-wrapper" style="display: flex;">
                                                    ...
                                                    <asp:DropDownList ID="ddlContactPersonMobCode" Width="67px" runat="server" CssClass="md-input">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Email</label>
                                                    <asp:TextBox ID="txtContactPersonEamil" runat="server" CssClass="md-input textlower"></asp:TextBox>
                                                    <span class="md-input-bar "></span>
                            ...
                            <div class="tab-pane" id="OtherDetails">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Reference By <span class="requiredFieldlable">*</span></label>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Bank</label>
                                                <div class="md-input-wrapper">
                                                    <asp:DropDownList ID="ddlBank" CssClass="md-input" runat="server">
                                                        <%--   <asp:ListItem Value="" Selected="">Select Bank</asp:ListItem>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Group</label>
                                                <div class="md-input-wrapper">
                                                    <asp:DropDownList ID="ddlGroupName" CssClass="md-input" runat="server">
                                                    </asp:DropDownList>
                                        ...
                                        <div class="col-sm-3" id="compIndusDiv">
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Company Industory</label>
                                                <div class="md-input-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3" id="OwnershipDiv">
                                            <div class="uk-width-medium uk-row-first">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Source Of Income <span class="requiredFieldlable">*</span></label>
                                        ...
                                        <div class="col-sm-3">
                                            <label>Politically Exposed Person (Pep)</label><br />
                                            <input type="checkbox" class="PepCheck" name="PepCheck" id="pepYes" value="YES" onclick="checkPep(this);" />
                                            Yes   
                                            <br />
                                            <input type="checkbox" class="PepCheck" name="PepCheck" id="pepNO" value="NO" onclick="checkPep(this);" />
                                            No
                            ...
                            <div class="tab-pane" id="BusinessDetail">
                                <br />
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="MainHEad">Business Details</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Department<span class="requiredFieldlable">*</span></label>
                                                <div class="md-input-wrapper">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Insurance Category<span class="requiredFieldlable">*</span></label>
                                                <div class="md-input-wrapper">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Business Class<span class="requiredFieldlable">*</span></label>
                                                <div class="md-input-wrapper">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="uk-width-medium uk-row-first">
                                                <label>Insurance Type<span class="requiredFieldlable">*</span></label>
                                                <div class="md-input-wrapper">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="sunDetail">Rates</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                ...
                                                <div class="md-input-wrapper">
                                                    <label>Exposure<span class="requiredFieldlable">*</span></label>
                                        ...
                                        <div class="col-sm-3" style="display: flex;">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Rate<span class="requiredFieldlable">*</span></label>
                                                    <input id="txtRate" required="" style="width: 120px" type="number" class="md-input" />
                                            ...
                                            <asp:DropDownList ID="ddlRateMil" required="" runat="server" CssClass="md-input">
                                                <asp:ListItem Selected="True">PERCENT</asp:ListItem>
                                                <asp:ListItem>PERMILLI</asp:ListItem>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="sunDetail">Agent</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="uk-width-medium uk-row-first">
                                                ...
                                                <div class="md-input-wrapper">
                                                    <asp:DropDownList ID="ddlProducer" required="" runat="server" CssClass="md-input">
                                                    </asp:DropDownList><span class="md-input-bar "></span>
                                                    <span class="md-input-bar "></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                <div class="md-input-wrapper">
                                                    <label>Commission Rate % <span class="requiredFieldlable">*</span></label>  
                                                    <input id="txtAggentRate"  required="" type="number" class="md-input" />
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="sunDetail">Installment<span class="requiredFieldlable">*</span></label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                ...
                                                <div class="md-input-wrapper">
                                                    <asp:DropDownList required="" ID="ddlInstalMode" runat="server" CssClass="md-input">
                                                        <asp:ListItem Value="" disabled="" Selected="" hidden="">SELECT INSTALLMENT</asp:ListItem>
                                                        <asp:ListItem>UPFRONT PAYMENT</asp:ListItem>
                                                        <asp:ListItem>QUARTERLY IN ADVANCE</asp:ListItem>
                                                        <asp:ListItem>QUARTERLY IN ARREARS</asp:ListItem>
                                                        <asp:ListItem>WITHIN 90 DAYS</asp:ListItem>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="uk-width-medium-1-6">
                                                ...
                                                <a class="btn btn-success" style="width: 80px; font-size: 12px; background-color: #096735;" id="addAgentDeptWiseRate" href="javascript:void(0)">Add</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md-card uk-margin-medium-bottom">
                                            <div class="md-card-content">
                                                <div class="uk-overflow-container">
                                                    ...
                                                    <table class="uk-table uk-table-striped uk-table-hover" id="tblAgentBusClassRate" runat="server">
                                                        <caption>Table caption</caption>
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <%-- <th id="AproveRate">Approve Rate</th>--%>
                                                            </tr>
                                                        </thead>
                            ...
                            <div class="tab-pane" id="BusniessInfo">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="clientFormMainHead">Business Rates Approval</label>
                                    </div>
                                </div>
                                <br />
                                <div id="BusClassRateDiv" style="display: none">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="col-sm-4">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    ...
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlDeptmentAgent" runat="server" CssClass="md-input">
                                                        </asp:DropDownList><span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    ...
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlBusClassCatAgent" runat="server" CssClass="md-input">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="uk-width-medium uk-row-first">
                                                    ...
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlBusClassAgent" runat="server" CssClass="md-input">
                                                        </asp:DropDownList><span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="uk-width-medium uk-row-first">
                                                    ...
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlInsuranceTypeAgent" runat="server" CssClass="md-input">
                                                        </asp:DropDownList><span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    ...
                                                    <div class="md-input-wrapper">
                                                        ...
                                                        <asp:TextBox required="" ID="txtExposureAgent" runat="server" CssClass="md-input"></asp:TextBox>
                                                        <span class="md-input-bar "></span>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    <div class="md-input-wrapper">
                                                        <label>Rate</label>
                                                        <asp:TextBox required="" ID="txtRateAgent" runat="server" CssClass="md-input"></asp:TextBox>
                                                        <span class="md-input-bar "></span>
                                                    ...
                                                    <table class="uk-table uk-table-striped uk-table-hover" id="tblBusClass" runat="server">
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th>Exposure</th>
                                                                <th>Rate</th>
                                                                <th style="width: 11%">Rate Type</th>
                                                                <th>Status</th>
                                                                <th></th>
                                                                <th></th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="icon-preview col s6 m3">
                                            ...
                                            <%-- <button class="btn btn-success" id="btnFinalizeOverCommission" style="width: 92px; font-size: 12px; background-color: #096735; display: none">
                                                FINALIZE</button>--%>
                                            <button class="btn btn-primary dropdown-toggle" id="btnFinalizeStandardRate" style="display: none; background-color: #26a69a;" type="button" data-toggle="dropdown">
                                                Finalize
                            ...
                            <div class="tab-pane" id="AgentProducer">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="clientFormMainHead">Agent Rates Approval</label>
                                    </div>
                                </div>
                                <div id="AgentRateDiv" style="display: none">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="uk-width-medium uk-row-first">
                                                    <label>Producer</label>
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList ID="ddlProducerAgent" required="" runat="server" CssClass="md-input">
                                                        </asp:DropDownList><span class="md-input-bar "></span>
                                                        <span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="uk-width-medium uk-row-first">
                                                    <label>Agent</label>
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlAgentAgent" CssClass="md-input" runat="server">
                                                        </asp:DropDownList>
                                                        <span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-3">
                                                <div class="uk-width-medium uk-row-first">
                                                    <label>Insurance Type</label>
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlAgentInsuranceType" runat="server" CssClass="md-input">
                                                        </asp:DropDownList><span class="md-input-bar "></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    <label>Installment Mode</label>
                                                    <div class="md-input-wrapper">
                                                        <asp:DropDownList required="" ID="ddlInstalModeAgent" runat="server" CssClass="md-input">
                                                            <asp:ListItem Value="" disabled="" Selected="" hidden="">SELECT INSTALLMENT</asp:ListItem>
                                                            <asp:ListItem>UPFRONT PAYMENT</asp:ListItem>
                                                            <asp:ListItem>QUARTERLY IN ADVANCE</asp:ListItem>
                                                            <asp:ListItem>QUARTERLY IN ARREARS</asp:ListItem>
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="uk-width-medium uk-row-first">
                                                    <div class="md-input-wrapper">
                                                        ...
                                                        <asp:TextBox required="" ID="txtAggentRateAgent" runat="server" CssClass="md-input"></asp:TextBox>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="uk-width-medium-1-6">
                                                    ...
                                                    <a class="btn btn-success" style="width: 80px; font-size: 12px; background-color: #096735;" id="addAgentDeptWiseRateAgent" href="javascript:void(0)">Add</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="md-card uk-margin-medium-bottom">
                                            <div class="md-card-content">
                                                <div class="uk-overflow-container">
                                                    ...
                                                    <table class="uk-table uk-table-striped uk-table-hover" id="tblAproveAgentRate" runat="server">
                                                        <caption>Table caption</caption>
                                                        <thead>
                                                            <tr>
                                                                <th>Client Code</th>
                                                                ...
                                                                <th>Agent Type</th>
                                                                <th>Status</th>
                                                                <th id="EditRateAgent"></th>
                                                                <th id="AproveRateAgent"></th>
                                                                <th></th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="icon-preview col s6 m3">
                                            <button id="btnBackBusniessInfoAproval" class="btn btn-success" style="width: 92px; font-size: 12px; background-color: #096735;">
                                                <i style="font-weight: bold; color: white;" class="material-icons dp48">arrow_back</i>Back</button>
                                            <button class="btn btn-success" id="btnAddAgentProducerAproval" style="width: 92px; font-size: 12px; background-color: #096735;">
                                                Next<i style="font-weight: bold; color: white;" class="material-icons dp48">arrow_forward</i></button>
                                            <button class="btn btn-success" id="btnFinalizeAgentRate" style="width: 92px; font-size: 12px; background-color: #26a69a; display: none">
                                                Finalize</button>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                            ...
                                            <div class="uk-width-medium uk-row-first">
                                                ...
                                                <div class="md-input-wrapper">
                                                    <asp:DropDownList required="" ID="ddlInstalMode" runat="server" CssClass="md-input">
                                                        ...
                                                        <asp:ListItem>UPFRONT PAYMENT</asp:ListItem>
                                                        <asp:ListItem>QUARTERLY IN ADVANCE</asp:ListItem>
                                                        <asp:ListItem>QUARTERLY YEARLY</asp:ListItem>
                                                        <asp:ListItem>WITH IN 90 DAYS</asp:ListItem>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="icon-preview col s6 m3">
                                            ...
                                            <button class="btn btn-success" id="btnAddInstallmentMode" style="width: 92px; font-size: 12px; background-color: #096735;">
                                                Next<i style="font-weight: bold; color: white;" class="material-icons dp48">arrow_forward</i></button>
                                            <button class="btn btn-primary dropdown-toggle" id="btnFinalizeInstallMode" style="display: none; background-color: #26a69a;" type="button" data-toggle="dropdown">
                                                Finalize
                            ...
                            <div class="tab-pane" id="Attachment">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label class="clientFormMainHead">Any Other Attachments</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="icon-preview col s6 m3">
                                            ...
                                            <button class="btn btn-success" id="btnFinalizeclientData" style="width: 92px; font-size: 12px; background-color: #096735;">
                                                Finalize</button>
                                            <%--  <button class="btn btn-success" id="btnFinalizeAproval" style="width: 92px; font-size: 12px; background-color: #096735;display:none">
                                                FINALIZE CLIENT</button>--%>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="icon-preview col s6 m3">
